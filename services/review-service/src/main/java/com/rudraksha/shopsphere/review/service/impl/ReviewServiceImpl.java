...
import com.rudraksha.shopsphere.review.exception.ReviewNotFoundException;
...
public class ReviewServiceImpl implements ReviewService {
    ...
    public Page<ReviewResponse> getProductReviews(Long productId, Pageable pageable) {
        Page<Review> page = reviewRepository
                .findByProductIdAndModerationStatusAndDeletedFalse(
                        productId,
                        Review.ModerationStatus.APPROVED,
                        pageable
                );
        return page.map(reviewMapper::reviewToReviewResponse);
    }
    ...
    public Page<ReviewResponse> getPendingReviews(Pageable pageable) {
        Page<Review> page = reviewRepository
                .findByModerationStatusAndDeletedFalse(Review.ModerationStatus.PENDING, pageable);
    ...
    public void deleteReview(Long id, Long userId) {
        ...
        log.info("Review {} soft-deleted by user {}", id, userId);
    }
