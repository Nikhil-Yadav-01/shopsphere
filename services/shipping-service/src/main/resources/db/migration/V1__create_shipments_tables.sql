...
(
    ...
    recipient_address_line1 VARCHAR
(
    255
),
    recipient_address_line2 VARCHAR
(
    255
),
...
(
    ...
    CONSTRAINT fk_shipments_order_id FOREIGN KEY
(
    order_id
) REFERENCES orders
(
...
(
    ...
    CONSTRAINT fk_tracking_events_shipment_id FOREIGN KEY
(
    shipment_id
